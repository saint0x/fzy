...
Native test manifests are first-class `trace verify` / `replay` / `ci` inputs for recorded native test runs. They are not scenario inputs and do not participate in scenario `shrink`.
