...
fn build_release_policy_json() -> serde_json::Value {
    serde_json::json!({
        ...
        "documentation": {
            "policy": "generate_from_implementation_where_possible",
        ...
        "releaseGating": {
            ...
            "versionsLockedInArtifacts": true,
            "benchmarksRequiredForRealFzyWorkloads": true,
            "diagnosticCatalogVersionRequired": true,
        },
    })
}
