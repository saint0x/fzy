...
pub(crate) fn extern_c_import_requires_unsafe(function: &TypedFunction) -> bool {
...
pub(crate) fn rpc_param_payload_violation(function: &TypedFunction) -> Option<(&str, &ast::Type)> {
...
pub(crate) fn rpc_return_payload_violation(function: &TypedFunction) -> Option<&ast::Type> {
    if !is_rpc_import(function) {
        return None;
    }
