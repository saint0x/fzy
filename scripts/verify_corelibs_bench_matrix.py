...
BENCHES = [
    ...
    ("log_kernel", "log", ROOT / "examples" / "benchmarks" / "log_scratch_bench.fzy"),
    ("error_kernel", "error", ROOT / "examples" / "benchmarks" / "error_scratch_bench.fzy"),
    ("http_kernel_oneoff", "http_oneoff", ROOT / "examples" / "benchmarks" / "http_oneoff_scratch_bench.fzy"),
    ("http_kernel_persistent", "http_persistent", ROOT / "examples" / "benchmarks" / "http_persistent_scratch_bench.fzy"),
